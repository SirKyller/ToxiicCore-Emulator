...
public class LookupService
{
    ...
    byte databaseType = byte.Parse(DatabaseInfo.COUNTRY_EDITION.ToString());
  ...
  "Saint Barthelemy","Saint Martin", "Bonaire, Saint Eustatius and Saba"};
    ...
    private void init()
    {
        ...
        for (i = 0; i < STRUCTURE_INFO_MAX_SIZE; i++)
        {
            ...
            {
                databaseType = byte.Parse(file.ReadByte().ToString());
                if (databaseType >= 106)
                {
            ...
            lock (this)
            {
                ...
                for (int i = 0; i < DATABASE_INFO_MAX_SIZE; i++)
                {
                    ...
                    if (delim[0] == 0 && delim[1] == 0 && delim[2] == 0)
                    {
                        ...
                        {
                            dbInfo2[a0] = char.Parse(dbInfo[a0].ToString());
                        }
    ...
    public Location getLocationV6(IPAddress addr)
    {
        ...
        try
        {
            ...
            {
                record_buf2[a0] = char.Parse(record_buf[a0].ToString());
            }
            // get country
    ...
    public String getOrgV6(IPAddress addr)
    {
        ...
        try
        {
            ...
            {
                buf2[str_length] = char.Parse(buf[str_length].ToString());
                str_length++;
            }
            buf2[str_length] = '\0';
